...
<body>
	<form action="controller" method="post">
			...
			<tbody>
				...
				<tr>
					...
					<td><input type="text" name="ISBN" pattern="[0-9]{10}"
						value="<%=bookBean.getISBN()%>" required></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="author"
						value="<%=bookBean.getAuthor()%>" pattern="([A-Z][a-z]+\s?)+"
						required></td>
				</tr>
				<tr>
					<th scope="row">Publisher</th>
					<td><input type="text" name="publisher"
						value="<%=bookBean.getPublisher()%>" pattern="([a-zA-Z0-9]+\s?)+"
						required></td>
				</tr>
				<tr>
					...
					<td><input type="text" name="description"
						value="<%=bookBean.getDescription()%>" required></td>
				</tr>
				<tr>
					<th scope="row">In Stock</th>
					<td><input type="number" name="inStock"
						value="<%=bookBean.getInstock()%>" required></td>
				</tr>
			</tbody>
		...
		<input type="hidden" name="action"
			value="<%=Constants.ACTION_UPDATE_BOOK%>">
		<button class="w3-button w3-right w3-light-gray"
